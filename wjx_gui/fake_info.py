...
class proxy():
    ...
    def get_proxy(self,origin):
        if origin == 'pool':
            ...
            with open('./origin_log', 'w+') as file:
                for i in response_list:
                    entry = self.encrypt(i.get('proxy'))
                    file.write('{0}\n'.format(format(entry)))
        else :
    ...
    def validate_proxy(self,filename):
        ...
        with open(filename, 'r') as file:
            ...
            for i in file_content:
                temp.append(self.decrypt(i))
            file.close()
            file_list = list(set(temp))
        try:
            file_list.remove('')
        except:
            pass
    ...
    def choose_proxy(self,filename):
        ...
        with open(filename, 'r') as file:
            file_content = file.readlines()
            for i in file_content:
                file_list.append(self.decrypt(i))
        return file_list
